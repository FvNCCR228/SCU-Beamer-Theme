...
% Version: 2026/06/15 v2.1d (Original Version: 2021/11/30 v1.0a).
...
% ----------------
\title[四川大学Beamer模板 | User's Manual Rev~v2.1d]{四川大学Beamer模板}
\subtitle{用户手册~~~~Rev v2.1d} % subtitle 未设置页脚显示项, 请在 title 中设置.
