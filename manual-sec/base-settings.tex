...
\begin{frame}{\pkg{beamethemescu} 宏包参数键值对说明(1/6)}{ColorDisplay, BlockDisplay}
...
\begin{frame}{\pkg{beamethemescu} 宏包参数键值对说明(2/6)}{CodeDisplay, MintedStyle, LanguageMode}
	\vspace*{-1.6ex}
	\begin{columns}[T, onlytextwidth]% https://tex.stackexchange.com/questions/7442
		\begin{column}{.5\textwidth}
			\textbf{调用命令}(无需额外调用默认键值对):\\
...
\begin{frame}{\pkg{beamethemescu} 宏包参数键值对说明(3/6)}{Miniframes, NavigationTool, LogoWidth}
	\vspace*{-1.6ex}
	\begin{columns}[T, onlytextwidth]% https://tex.stackexchange.com/questions/7442
		\begin{column}{.5\textwidth}
			\textbf{调用命令}(无需额外调用默认键值对):\\
...
\begin{frame}{\pkg{beamethemescu} 宏包参数键值对说明(4/6)}{FontTheme, MathFont}
	\begin{columns}[T, onlytextwidth]% https://tex.stackexchange.com/questions/7442
		\begin{column}{.5\textwidth}
			\textbf{调用命令}(无需额外调用默认键值对):\\
			\cmd{usetheme}\oarg*{\%\\
...
\begin{frame}{\pkg{beamethemescu} 宏包参数键值对说明(5/6)}{Background, VI}
	\begin{columns}[T, onlytextwidth]% https://tex.stackexchange.com/questions/7442
		\begin{column}{.5\textwidth}
			\textbf{调用命令}(无需额外调用默认键值对):\\
			\cmd{usetheme}\oarg*{\%\\
...
\begin{frame}{\pkg{beamethemescu} 宏包参数键值对说明(6/6)}{BIBMode, BIBStyle, ContentMuticols}
	\begin{columns}[T, onlytextwidth]% https://tex.stackexchange.com/questions/7442
		\begin{column}{.5\textwidth}
			\textbf{调用命令}(无需额外调用默认键值对):\\
			\cmd{usetheme}\oarg*{\%\\
