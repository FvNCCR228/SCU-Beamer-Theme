...
\begin{frame}{\pkg{beamethemescu} 宏包参数键值对说明(1/4)}{MathFont, ColorDisplay, CodeDisplay}
...
\begin{frame}{\pkg{beamethemescu} 宏包参数键值对说明(2/4)}{MintedStyle, BlockDisplay, LanguageMode}
	\vspace*{-1.6ex}
	\begin{columns}[T, onlytextwidth]% https://tex.stackexchange.com/questions/7442
		\begin{column}{.5\textwidth}
			\textbf{调用命令}(无需额外调用默认键值对):\\
...
\begin{frame}{\pkg{beamethemescu} 宏包参数键值对说明(3/4)}{Miniframes, NavigationTool}
	\vspace*{-1.6ex}
	\begin{columns}[T, onlytextwidth]% https://tex.stackexchange.com/questions/7442
		\begin{column}{.5\textwidth}
			\textbf{调用命令}(无需额外调用默认键值对):\\
...
\begin{frame}{\pkg{beamethemescu} 宏包参数键值对说明(4/4)}{BIBMode, BIBStyle, ContentMuticols, Background}
	\begin{columns}[T, onlytextwidth]% https://tex.stackexchange.com/questions/7442
		\begin{column}{.5\textwidth}
			\textbf{调用命令}(无需额外调用默认键值对):\\
			\cmd{usetheme}\oarg*{\%\\
