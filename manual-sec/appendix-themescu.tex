...
\begin{frame}{\texttt{main} 分支文件结构 \scugoback{back:BranchMain}{BACK}}\label{goto:BranchMain}
  ...
  \begin{multicols}{2}
    ...
    .2 dev/\DTcomment{\alert{开发辅助脚本}[开发]}.
    ...
    .3 background\ldots.png.\DTcomment{\text{背景}[主题]}.
    .2 sourcecode/\DTcomment{\alert{代码存放}[资源]}.
    .2 tmp/\DTcomment{\alert{缓存}[缓存]}.
    .3 minted/\DTcomment{\alert{minted缓存}[缓存]}.
    ...
    .2 beamerfontthemescu.sty\DTcomment{\alert{\textbf{字体主题}}[主题]}.
    .2 beamerinnerthemescu.sty\DTcomment{\alert{\textbf{内部主题}}[主题]}.
...
\begin{frame}{\texttt{manual} 分支文件结构 \scugoback{back:BranchManual}{BACK}}\label{goto:BranchManual}
  ...
  \begin{multicols}{2}
    ...
    .4 \ldots.tex\DTcomment{\alert{示例tex文件}[演示]}.
    .4 \ldots.pdf\DTcomment{\alert{示例pdf文件}[演示]}.
    .3 tikz-\ldots.tex\DTcomment{\alert{TikZ 绘图}[章节]}.
